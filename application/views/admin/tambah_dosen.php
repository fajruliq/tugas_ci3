            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Dashboard Data Dosen</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-end"><a class="btn btn-primary" href="<?php base_url(); ?>dosen/tambah_dosen" role="button">Tambah Data</a></div>
                </div>
